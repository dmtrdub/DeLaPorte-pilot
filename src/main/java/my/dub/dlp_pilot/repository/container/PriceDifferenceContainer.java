...
public class PriceDifferenceContainer {
    ...
    private boolean isSimilarMatch(PriceDifference existingPD, String base, String target, ExchangeName exchange1,
            ExchangeName exchange2) {
        return existingPD.getBase().equals(base) && existingPD.getTarget().equals(target) && existingPD
                .getExchangeName().equals(exchange1) && existingPD.getExchangeName2().equals(exchange2);
    }
}
